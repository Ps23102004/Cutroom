...
## Stack
User mandate: React, TypeScript and Vite in Tauri; Rust native core; SQLite; dedicated FFmpeg and ASR workers; optional Next.js browser review. Ordinary implementation choices delegated to Astra and real workers.

## Users
Independent creators, freelance editors and small teams producing speech-led recordings. Browser clients review exact shared renditions.
